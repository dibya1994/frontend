...
export default function update() {
    ...
    useEffect(()=>{
        ...
        fetch(`http://localhost:8000/api/user-edit/${id}`).then((a)=>{
          return a.json();
        })
          .then((parsed)=>{
              setBlogs(parsed);
    ...
    const onsubmitHandler=(e)=>{
        e.preventDefault();
        // alert(id+" "+name+ " "+email+" "+phone+" "+password);
        const data={cid , name , email ,phone , password};
        if(name=="")
        {
        ...
        // console.log(cid +" "+name+" "+email+" "+phone+" "+password);
  ...
  <div className="row">
    ...
    <div className="card">
        <div className="card-body">
            <h5 className="card-title">Update Page {id}</h5>
                {success 
                       ? 
            ...
            <div className="row">
                <div className="col-md-12">
                    <div className="mb-3">
                        ...
                        <input type="hidden" className="form-control" name="cid" value={cid}  />
                    </div>
                    <div className="mb-3">
